...
/**
 * Command for depositing money into a wallet.
 * Immutable command object following CQRS pattern.
 */
public final class DepositMoneyCommand {
    ...
    public DepositMoneyCommand(String walletId, BigDecimal amount, String currency, String description) {
        ...
        this.description = description != null ? description.trim() : "Deposit";
    }
